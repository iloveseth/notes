...
cc.Class({
    ...
    updateView(data) {
        ...
        let baseInfo = data.ba_info;
        let firtInfo = data.fi_info;
        let secondInfo = data.se_info;
        let thirdInfo = data.th_info;
        let godInfo = data.god_info;
        ...
        this.Label_minjie.setText(`${firtInfo.wddex}`);
        this.Label_zhili.setText(`${firtInfo.wdint}`);
        this.Label_naili.setText(`${firtInfo.wdcon}`);

        this.Label_zhushuxing.setText(Game.UserModel.GetMainProps(Game.UserModel.GetOccupation(baseData.face*10)));
        ...
        this.Label_baoji_Soul.setText(`${(godInfo.bangval_per * 100).toFixed(1)}%`);
